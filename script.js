const dictionary = {
    es: {
        ...
        viab_comp_desc: "<ul style='list-style-type: disc; padding-left: 20px; line-height: 1.6;'><li class='mb-2'><strong>Fabricantes de Equipo Original (OEM):</strong> Gigantes como John Deere y Kubota representan la competencia principal, integrando la venta de maquinaria con su propia línea de repuestos y cojines originales (Genuine Parts).</li><li class='mb-2'><strong>Fabricantes Especializados:</strong> Empresas como GRAMMER y Seats Inc. compiten a través de la especialización técnica, enfocándose en soluciones ergonómicas, comodidad y durabilidad superiores para el sector agrícola.</li><li class='mb-2'><strong>Mercado de Reposición (Aftermarket):</strong> Distribuidores como TractorSeats.com evidencian una demanda real por repuestos no originales, donde los usuarios finales comparan alternativas basándose en precio, compatibilidad y disponibilidad de kits de suspensión.</li><li class='mb-2'><strong>Estructura competitiva de tres frentes:</strong> Una empresa de internacionalización de sillines debe enfrentar a las marcas líderes de maquinaria, a los fabricantes expertos en sistemas de asientos y a los comercializadores de repuestos compatibles para el mercado de reposición.</li></ul>",
    ...
    en: {
        ...
        viab_comp_desc: "<ul style='list-style-type: disc; padding-left: 20px; line-height: 1.6;'><li class='mb-2'><strong>Original Equipment Manufacturers (OEM):</strong> Giants like John Deere and Kubota represent the main competition, integrating machinery sales with their own line of replacement parts and original cushions (Genuine Parts).</li><li class='mb-2'><strong>Specialized Manufacturers:</strong> Companies like GRAMMER and Seats Inc. compete through technical specialization, focusing on superior ergonomic solutions, comfort, and durability for the agricultural sector.</li><li class='mb-2'><strong>Aftermarket Sector:</strong> Distributors like TractorSeats.com evidence real demand for non-original replacement parts, where end-users compare alternatives based on price, compatibility, and suspension kit availability.</li><li class='mb-2'><strong>Three-front competitive structure:</strong> A saddle internationalization company must face leading machinery brands, expert seat system manufacturers, and compatible replacement marketers for the aftermarket.</li></ul>",
