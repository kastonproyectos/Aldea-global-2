const dictionary = {
    es: {
        ...
        intro_dofa: "Diagnóstico transversal que categoriza los ejes orgánicos (virtudes y fricciones) expuestos perimetralmente sobre la exigencia técnica del entorno base en Estados Unidos.",
